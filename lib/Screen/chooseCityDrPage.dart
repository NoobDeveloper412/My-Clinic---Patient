import 'package:demopatient/Screen/aboutUsDrList.dart';
...
class CityDRListPage extends StatefulWidget {
  @override
  _CityDRListPageState createState() => _CityDRListPageState();
}

class _CityDRListPageState extends State<CityDRListPage> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AboutUsDoctorsListPage(

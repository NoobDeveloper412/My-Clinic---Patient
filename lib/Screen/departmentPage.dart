...
class ChooseDepartmentPage extends StatefulWidget {
  ...
  ChooseDepartmentPage({this.clinicId,this.clinicName,this.clinicLocationName,this.cityId,this.cityName});
  @override
...
class _ChooseDepartmentPageState extends State<ChooseDepartmentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        CAppBarWidget(title: "Select Department"), //common app bar
        Positioned(
          top: 80,
          left: 0,
          right: 0,
          ...
          child: Container(
            ...
            child: FutureBuilder(
                future:
                    DepartmentService.getData(widget.clinicId,widget.cityId), //fetch images form database
